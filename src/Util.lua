...
--[[ 
    MBG - some notes about positions 
    key: y = 48, x = 32*5 - dimensions are 32x16 (x,y)
    balls: y = 48, x = 32*3 - dimensions are 8x8 - 7 balls (across two rows)
    powerups: x = 0, y = 12*16; dimensions are 16x16 (10 including key)
    key powerup: x = 32*5 - 16, y = 12*16
...
function GenerateQuadsPowerups(atlas)
    ...
    for i = 0, 9 do --make sure this gets the last one 
